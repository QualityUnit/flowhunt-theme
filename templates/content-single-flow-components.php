...
$page_header_logo = array(
	...
	'alt' => __( 'Flow component', 'flowhunt' ),
);
...
$current_id       = apply_filters( 'wpml_object_id', $post->ID, 'flow-components' );
$categories       = get_the_terms( $current_id, 'flow_components_categories' );
$categories_url   = get_post_type_archive_link( 'flow-components' );
