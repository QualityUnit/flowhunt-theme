...
$categories = array_unique( get_categories( array( 'taxonomy' => 'flow_templates_categories' ) ), SORT_REGULAR );
if ( is_tax( 'flow_templates_categories' ) ) :
...
$page_header_args = array(
	'type'   => 'lvl-1',
	'image'  => array(
		'src' => get_template_directory_uri() . '/assets/images/flow_templates_img.png?ver=' . THEME_VERSION,
	...
	<div class="wrapper">
			<ul class="Posts__items Archive__columns list">
				...
				while ( have_posts() ) :
					...
					$category = '';
					$categories = get_the_terms( 0, 'flow_templates_categories' );
