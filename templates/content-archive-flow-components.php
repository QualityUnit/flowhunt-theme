...
$categories = array_unique( get_categories( array( 'taxonomy' => 'flow_components_categories' ) ), SORT_REGULAR );
if ( is_tax( 'flow_components_categories' ) ) :
	$page_header_title       = single_cat_title();
	$page_header_description = the_archive_description();
else :
	$page_header_title       = __( 'Flow Components', 'flowhunt' );
	$page_header_description = __( 'Lorem ipsum dolor sit amet consectetur adipiscing, elit ante proin nunc sem pulvinar condimentum', 'flowhunt' );
endif;
...
$page_header_args = array(
	'type'   => 'lvl-1',
	'image'  => array(
		'src' => get_template_directory_uri() . '/assets/images/flow_components_img.png?ver=' . THEME_VERSION,
...
<div class="Posts Flow-components" itemScope itemType="http://schema.org/Collection">
	...
	<div class="wrapper">
			<ul class="Posts__items Archive__columns list">
				...
				while ( have_posts() ) :
					...
					$category = '';
					$categories = get_the_terms( 0, 'flow_components_categories' );
